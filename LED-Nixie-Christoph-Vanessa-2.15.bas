...
108:
    ...
    if s % 10 = 2 or s % 10 = 6 and (IO.eeread(5)) = 1 and (IO.eeread(18)) = 0 and r = 2 and v > 5 gosub 700 ' show alarm time
...
22300: ' save Begin Nightmode
    ...
    goto 10105 ' return to system menu
'================================================
' S9: NIGHTMODE BRIGHTNESS SELECTION
' VAR: y,t,z,k
23000:
    gosub 9100          ' BEEP
    y = IO.eeread(25)    ' Read NIGHTMODE Brightness Value from EEPROM
23005:
    z = 0               ' counter
    IO.setenc(y, 15, 0) ' 15 NIGHTMODE brightness values
23010:
    t = IO.getenc()
    if t = y goto 23020
    y = t
